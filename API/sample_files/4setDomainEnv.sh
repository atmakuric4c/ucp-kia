...
WL_HOME="/web/wls12.2.1.3/wlserver"
export WL_HOME
...
SUN_JAVA_HOME="/usr/java/jdk1.8.0_301-amd64"
export SUN_JAVA_HOME

DEFAULT_SUN_JAVA_HOME="/usr/java/jdk1.8.0_301-amd64"
...
DOMAIN_HOME="/appl/<service Name>"
export DOMAIN_HOME

LONG_DOMAIN_HOME="/appl/<service Name>"
...
USER_MEM_ARGS="-Xms512m -Xmx512m -XX:MaxPermSize=512m"
export USER_MEM_ARGS
fi



#In case of 4 managed servers

if [ "${SERVER_NAME}" == "<service Name>_managed_01" ] ; then
USER_MEM_ARGS="-Xms1024m -Xmx1024m -XX:MaxPermSize=1024m"
export USER_MEM_ARGS
fi


if [ "${SERVER_NAME}" == "<service Name>_managed_02" ] ; then
USER_MEM_ARGS="-Xms1024m -Xmx1024m -XX:MaxPermSize=1024m"
export USER_MEM_ARGS
fi

if [ "${SERVER_NAME}" == "<service Name>_managed_03" ] ; then
USER_MEM_ARGS="-Xms1024m -Xmx1024m -XX:MaxPermSize=1024m"
export USER_MEM_ARGS
fi

if [ "${SERVER_NAME}" == "<service Name>_managed_04" ] ; then
USER_MEM_ARGS="-Xms1024m -Xmx1024m -XX:MaxPermSize=1024m"
export USER_MEM_ARGS
fi
