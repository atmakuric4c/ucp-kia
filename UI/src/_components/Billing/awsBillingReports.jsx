...
import DatatablePage from './awsBillingReportGridview';
import PageLoader from '../PageLoader';
import DatePicker from "react-datepicker";
import moment from 'moment';
import config from 'config';
import { toast } from 'react-toastify';
import { exportBillingReportExcel } from '../../_helpers';
...
class AwsBillingReport extends React.Component {
  constructor(props) {
    super(props);
  ...
  searchBillingReports = e => {
    ...
    let params = {clientid:this.state.clientid,start_date:start_date,end_date:end_date,
      set:1,limit:1000}
    this.props.dispatch(billingActions.getAwsBillingReports(params));
  };
  
  render() { 
    const { billingCommon } = this.props;
    let billingReports = billingCommon.awsReports;

    return (
      <div className="container-fluid main-body">
        <div className="contentarea">
          <h5 className="color">AWS Billing Report</h5>
          <form
              method="post"
          ...
          <div className="row" style={{'padding':'0 20px'}}>
            <div className="col-sm-3">
              ...
              <button onClick={e => { 
                ...
                exportBillingReportExcel({data: billingReports.data, start_date: this.state.start_date, end_date: this.state.end_date}) : 
...
const connected = connect(mapStateToProps)(AwsBillingReport);
export { connected as AwsBillingReport };