...
class Ticketlist extends React.Component {
  ...
  render() {
    ...
    let configdata = this.props.myticket.configdata;
    return (
      <div className="container-fluid main-body">
        ...
        <Modal
          ...
          <h2 style={{ color: 'red' }}>
            Create Ticket <a className="float-right" href="/#/ticketlist" onClick={this.closeModalTicket}><i className="fa fa-times" /></a>
          </h2>
