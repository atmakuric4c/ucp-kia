...
import GcpRepoListDatatablePage from './gcpRepoListGridView';
import PageLoader from '../PageLoader';

Modal.setAppElement("#app");
class GcpRepoList extends React.Component {
  constructor(props) {
    super(props);
  ...
  projectChange = (project) => {
    ...
    this.props.dispatch(gcpDevopsActions.getRepoList(params));
  }
  ...
  render() { 
    ...
    let gcpRepoList = gcpDevops.gcpRepoList;
    let options = '';
    ...
    return (
      <div className="container-fluid main-body">
        <div className="contentarea">
          <h5 className="color">GCP Repository List</h5>
          <div className="row">
          ...
          {gcpRepoList && <GcpRepoListDatatablePage gcpRepoList={gcpRepoList}/> }
        </div>
      </div>
    );
  }
...
const connected = connect(mapStateToProps)(GcpRepoList);
export { connected as GcpRepoList };