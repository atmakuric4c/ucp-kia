...
class LinuxWeblogic extends Component {
	constructor(props) {
		super(props);
						...
						<ul className="sidebar-menu" id="nav-accordion">
							...
							<li className="sub-menu">
								<span className="d-flex ugMenu firstlinuxRef" onClick={(e) => this.scrollToSection({ submenu: "firstlinuxSubMenu", ref: "firstlinuxRef" })}>
									<i className="far fa-file-alt fa-fw"></i>
									<small data-submenu="firstlinuxSubMenu">3 How do I deploy my first machine?</small>
								</span>
					...
					<section className="wrapper">
						...
						<section className="card getaccess" id="getaccess">
							...
							<div className="card-body">
								...
								<div className="mb-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/form1.png" />
								</div>
						...
						<section className="card" id="firstlinux">
							<header className="card-header" ref={this.firstlinuxRef}>
								<h5>3 How do I deploy my first machine? </h5>
							</header>
							<div className="card-body">
								<p><a href="#">https://ucp.dhl.com</a></p>
								<div className="mb-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic1.png" />
								</div>
								<p>Click on Login and enter your credentials</p>
								<div className="mb-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic2.png" />
								</div>
								...
								<div className="mb-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic3.png" />
								</div>
								<p>In order to provision your first machine or Service Order, Clicking on Order -&gt; New VM Instance -&gt; Azure</p>
								<div className="mb-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic4.png" />
								</div>
							...
							<div className="card-body">
								...
								<ul className="alpha">
									...
									<li>Servers being provisioned for <strong><u>Test</u></strong> purpose, please select <u>ITS-SPCS-Azure-Managed-VM-TEST-123</u>
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic5.png" />
										</div>
									</li>
									...
									<li>Servers can be provisioned based on two types of Operating Systems
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic6.png" />
										</div>
									</li>
									<li>Selecting Linux Will show the Add-Ons as below.
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic7.png" />
										</div>
									</li>
									<li>By selecting Linux + Weblogic server the following Weblogic Images will appear.
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic8.png" />
										</div>
									</li>
									<li>After selecting the desired image the latest version of the image will appear automatically.
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic9.png" />
										</div>
									</li>
									<li><b>There are two types of Environments</b>
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic10.png" />
										</div>
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic11.png" />
										</div>
									</li>
									<li><strong> Network Identity Selection. There are two types of Network identity option.</strong>
										<ul className="alpha">
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic12.png" />
										</div>
									</li>
									...
									<li>Please select the desired Region. The selected region is the datacenter where the requested server will be provisioned.
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic13.png" />
										</div>
									</li>
									<li><b>Based on the region selected, the corresponding Virtual Network is automatically selected along with the subnet.</b>
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic14.png" />
										</div>
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic15.png" />
										</div>
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic16.png" />
										</div>
									</li>
									<li><b>Select the number of servers that need to be provisioned in a single order.</b>
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic17.png" />
										</div>
									</li>
									...
									<li><b>For every order either an Availability Zone / Availability Set / None option can be selected.</b>
										<ul className="alpha">
											<li><b>Availability Zone:</b> Azure regions and availability zones are physically separate locations within each Azure region that are tolerant to datacenter failures because of redundant infrastructure and logical isolation of Azure services. There are 3 zones numbered 1/2/3 available in UCP to provision servers.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic18.png" />
												</div>
											</li>
											<li><b>Availability Set:</b> An availability set is a logical grouping of VMs that allows Azure to understand how your application is built to provide for redundancy and availability. We recommended that two or more VMs are created within an availability set to provide for a highly available application and to meet the 99.95% Azure SLA
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic19.png" />
												</div>
											</li>
											<li><b>Create Availability Set:</b> Availability Set Name will be listing out the Sets that are already configured in the Subscription. If there are no availability sets and if you wish to create one, then the "Create New" button will allow you to create a New Availability set.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic20.png" />
												</div>
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic21.png" />
												</div>
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic22.png" />
												</div>
											</li>
										</ul>
									</li>
									<li>After selected all the relevant options please click on Next on the bottom Right of the screen.
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic23.png" />
										</div>
									</li>
								</ul>
							</div>
						...
						<section className="card" id="vmdetails1">
							...
							<div className="card-body">
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic24.png" />
								</div>
								<ul className="alpha">
									<li>Select the desired server size by clicking on "Select VM Size" which will then show the list of VM sizes available for the relevant image.
										<ul className="alpha">
											<li><b>Note:</b> For each image of Linux & Windows only the supported list of VM SKUs will appear for selection.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic25.png" />
												</div>
											</li>
									...
									<li>User can select the desired Operating System Storage Type from the list shown below.
										...
										<ul className="alpha">
											...
											<li><b>Standard_LRS :</b> This type of OS Disk is a Hard Disk Drive which is Locally Redundant Storage
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic26.png" />
												</div>
											</li>
										</ul>
									</li>
									...
									<li>However, a relevant zone can be selected based on previous selection in Step-3.p
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic27.png" />
										</div>
									</li>
									<li>User may choose to add Additional disks if required. This is possible by clicking on Add Disks button.
										<ul className="alpha">
											...
											<li>You may also select additional disks based on available disk types & sizes.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic28.png" />
												</div>
											</li>
											<li>Disk Storage SKU1 dropdown option will provide the list of supported disk types along with the size of the disk.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic29.png" />
												</div>
											</li>
											<li>After selecting relevant disk type & size, Disk Host caching can be selected based on the options available.
											</li>
											<li>Weblogic service name has to be provided by the user
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic30.png" />
												</div>
											</li>
											<li><b>Note :</b> The effective disk size available to configure will be wary between 60% to 80% depending on the size of the disk. Please read the note next to the disk details.
											</li>
											<li>After configuring the desired option, click "NEXT" on the bottom right to configure Backup for the server being provisioned and Global Service Now Details for Business purposes.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/pic31.png" />
												</div>
											</li>
								...
								<ul className="alpha">
										...
										<ul className="alpha">
											...
											<li>
												<ol className="alpha">
													...
													<div className="my-4">
														<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture35.png" />
													</div>
													<div className="my-4">
														<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture36.png" />
													</div>
												</ol>
											</li>
										</ul>
									...
									<li>For Global Service Now Business details the Following options can be selected
										...
										<ol className="roman">
											<li>IMPACT
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture37.png" />
												</div>
											</li>
											<li>Impacted BUSINESS UNIT

												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture38.png" />
												</div>
											</li>
											<li>Impacted COUNTRY
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture39.png" />
												</div>
											</li>
											...
											<li>Impacted region is automatically selected based on the Impacted Country.
												<ol>
													...
													<div className="my-4">
														<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture40.png" />
													</div>
												</ol>
											...
											<li>Impacted service can be selected based on the list of 4000+ services available
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture41.png" />
												</div>
											</li>
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture42.png" />
										</div>
									</li>
						...
						<section className="card" id="orderlist">
							...
							<div className="card-body">
								...
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture43.png" />
								</div>

								<p>After clicking on Submit Button the preview of the Order is visible in the next screen.</p>
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture44.png" />
								</div>
								<p>The Team Manager or Resource Group Owner only can click on Proceed to Provisioning button to order the server.</p>
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture45.png" />
								</div>
								...
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture46.png" />
								</div>
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture47.png" />
								</div>
						...
						<section className="card" id="informationmenu">
							...
							<div className="card-body">
								...
								<div className="mb-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture48.png" />
								</div>
						...
						<section className="card" id="myserver">
							...
							<div className="card-body">
								...
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture49.png" />
								</div>

								<ul className="alpha">
									<li>S
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture50.png" />
										</div>
									</li>

									<li>Click on VM Details Button to view the details of the server that has been provisioned.
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture51.png" />
										</div>
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/LinuxWeblogic/picture52.png" />
										</div>
									</li>
								</ul>
							</div>
...
export { LinuxWeblogic as LinuxWeblogic };