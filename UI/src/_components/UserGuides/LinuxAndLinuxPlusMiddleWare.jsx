...
class LinuxAndLinuxPlusMiddleWare extends Component {
	constructor(props) {
		super(props);
		...
		this.firstlinuxRef = React.createRef();
				...
				<aside>
					...
					<div id="sidebar" className="fixedElement nav-collapse ">
						...
						<ul className="sidebar-menu" id="nav-accordion">
							...
							<li className="sub-menu">
								<span className="d-flex ugMenu firstlinuxRef" onClick={(e) => this.scrollToSection({ submenu: "firstlinuxSubMenu", ref: "firstlinuxRef" })}>
									<i className="far fa-file-alt fa-fw"></i>
									<small data-submenu="firstlinuxSubMenu">3 How do I deploy my first Linux OS Machine?</small>
								</span>
					...
					<section className="wrapper">
						<section className="card" id="introduction">
							...
							<div className="card-body">
								...
								<ul className="alpha">
									<li>Plain Linux Images</li>
									<li>Apache HTTPD Linux Images</li>
									<li>Apache TOMCAT Linux Images</li>
									<li>JBOSS Linux Images</li>
								</ul>
						...
						<section className="card getaccess" id="getaccess">
							...
							<div className="card-body">
								...
								<div className="mb-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/form1.png" />
								</div>
						...
						<section className="card" id="firstlinux">
							<header className="card-header" ref={this.firstlinuxRef}>
								<h5>3 How do I deploy my first Linux OS machine? </h5>
							</header>
							<div className="card-body">
								...
								<div className="mb-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture1.png" />
								</div>
								<p>Click on Login and enter your credentials</p>
								<div className="mb-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture2.png" />
								</div>
								...
								<div className="mb-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture3.png" />
								</div>
								<p>In order to provision your first machine or Service Order, Clicking on Order -&gt; New VM Instance -&gt; Azure</p>
								<div className="mb-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture4.png" />
								</div>
							...
							<div className="card-body">
								...
								<ul className="alpha">
									...
									<li>Servers being provisioned for <strong><u>Test</u></strong> purpose, please select <u>ITS-SPCS-Azure-Managed-VM-TEST-123</u>
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture5.png" />
										</div>
									</li>
									...
									<li>Servers can be provisioned based on two types of Operating Systems
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture6.png" />
										</div>
									</li>


									<li>Selecting Linux operating system will show the Add-Ons as below.

										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture7.png" />
										</div>
									</li>


									<li>Selecting relevant Add-on will then filter the related images with which servers can be provisioned. For example this is how a Plain Linux template can be selected.

										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture8.png" />
										</div>
									</li>
									...
									<li>After selecting the desired image the latest version of the image will appear automatically.
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture9.png" />
										</div>
									</li>
									...
									<li><b>There are two types of Environments</b>
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture10.png" />
										</div>
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture11.png" />
										</div>
									</li>
									...
									<li><strong> Identity Selection. There are two types of Network identity option.</strong>
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture12.png" />
										</div>
									</li>

									<li>Network Resource Group is set to Default always.
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture13.png" />
										</div>
									...
									<li>Please select the desired Region. The selected region is the datacenter where the requested server will be provisioned.
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture14.png" />
										</div>
									</li>
									...
									<li><b>Based on the region selected, the corresponding Virtual Network is automatically selected along with the subnet.</b>
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture15.png" />
										</div>
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture16.png" />
										</div>
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture17.png" />
										</div>
									</li>
									...
									<li><b>Select the number of servers that need to be provisioned in a single order.</b>
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture18.png" />
										</div>
									...
									<li><b>For every order either an Availability Zone / Availability Set / None option can be selected.</b>
										...
										<ul className="alpha">
											<li><b>Availability Zone:</b> Azure regions and availability zones are physically separate locations within each Azure region that are tolerant to datacenter failures because of redundant infrastructure and logical isolation of Azure services. There are 3 zones numbered 1/2/3 available in UCP to provision servers.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture19.png" />
												</div>
											</li>
											<li><b>Availability Set:</b> An availability set is a logical grouping of VMs that allows Azure to understand how your application is built to provide for redundancy and availability. We recommended that two or more VMs are created within an availability set to provide for a highly available application and to meet the 99.95% Azure SLA
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture20.png" />
												</div>
											</li>
											...
											<li><b>Create Availability Set:</b> Availability Set Name will be listing out the Sets that are already configured in the Subscription. If there are no availability sets and if you wish to create one, then the "Create New" button will allow you to create a New Availability set.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture21.png" />
												</div>
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture22.png" />
												</div>
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture23.png" />
												</div>
											</li>
										</ul>
									...
									<li>After selected all the relevant options please click on Next on the bottom Right of the screen.
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture24.png" />
										</div>
						...
						<section className="card" id="vmdetails1">
							...
							<div className="card-body">
								<p>The next page allows the user to select the Base Machine details.</p>

								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture25.png" />
								</div>
								...
								<ul className="alpha">
									<li>Select the desired server size by clicking on "Select VM Size" which will then show the list of VM sizes available for the relevant image.
										...
										<ul className="alpha">
											<li><b>Note:</b> For each image of Linux & Windows only the supported list of VM SKUs will appear for selection.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture26.png" />
												</div>
											</li>
									...
									<li>User can select the desired Operating System Storage Type from the list shown below.
										...
										<ul className="alpha">
											...
											<li><div className="my-4">
												<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture27.png" />
											</div></li>
										</ul>
									</li>
									...
									<li>However, a relevant zone can be selected based on previous selection in Step-3.p
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture28.png" />
										</div>
									</li>

									<li>User may choose to add Additional disks if required. This is possible by clicking on Add Disks button.
										<ul className="alpha">
											<li><b>Note :</b> The number of maximum disks that can be added is pre-defined by the Size of the base machine that has been selected in Step-4.a.a</li>
											<li>In the below mentioned example a server size is selected where it can support only 2 additional disks.</li>
											<li>You may also select additional disks based on available disk types & sizes.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture29.png" />
												</div>
											</li>
											<li>Disk Storage SKU1 dropdown option will provide the list of supported disk types along with the size of the disk.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture30.png" />
												</div>
											</li>
											<li>After selecting relevant disk type & size, Disk Host caching can be selected based on the options available.

												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture31.png" />
												</div>
											</li>
											<li>Mount-points to each disk can be defined by clicking on Add Mount-points button.</li>
											<li><b>Note :</b> As many mount-points as possible can be defined in this section, however the sum of all partitions of the mount-points cannot be exceed 5GB less of Disk Size. Meaning if a 32GB disk is selected, the sum of all partitions cannot be greater than 27 GB.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture32.png" />
												</div>
											</li>
											<li>A mount-point needs to be defined with a "/" before and after mount-point name; and the label name will be automatically populate for every mount point as per the format mentioned in the text box.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture33.png" />
												</div>
											</li>
											<li>After configuring the desired option, click "NEXT" on the bottom right to configure Backup for the server being provisioned and Global Service Now Details for Business purposes.
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture34.png" />
												</div>
											</li>
								...
								<ul className="alpha">
										...
										<ul className="alpha">
											...
											<li>
												<ol className="alpha">
													...
													<div className="my-4">
														<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture35.png" />
													</div>
													<div className="my-4">
														<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture36.png" />
													</div>
												</ol>
											</li>
										</ul>
									...
									<li>For Global Service Now Business details the Following options can be selected
										...
										<ol className="roman">
											<li>IMPACT
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture37.png" />
												</div>
											</li>
											<li>Impacted BUSINESS UNIT

												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture38.png" />
												</div>
											</li>
											<li>Impacted COUNTRY
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture39.png" />
												</div>
											</li>
											...
											<li>Impacted region is automatically selected based on the Impacted Country.
												<ol>
													...
													<div className="my-4">
														<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture40.png" />
													</div>
												</ol>
											...
											<li>Impacted service can be selected based on the list of 4000+ services available
												<div className="my-4">
													<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture41.png" />
												</div>
											</li>
										...
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture42.png" />
										</div>
									</li>
						...
						<section className="card" id="orderlist">
							...
							<div className="card-body">
								...
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture43.png" />
								</div>

								<p>After clicking on Submit Button the preview of the Order is visible in the next screen.</p>
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture44.png" />
								</div>
								<p>The Team Manager or Resource Group Owner only can click on Proceed to Provisioning button to order the server.</p>
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture45.png" />
								</div>
								...
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture46.png" />
								</div>
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture47.png" />
								</div>
						...
						<section className="card" id="informationmenu">
							...
							<div className="card-body">
								...
								<div className="mb-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture48.png" />
								</div>
						...
						<section className="card" id="myserver">
							...
							<div className="card-body">
								...
								<div className="my-4">
									<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture49.png" />
								</div>

								<ul className="alpha">
									<li>S
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture50.png" />
										</div>
									</li>

									<li>Click on VM Details Button to view the details of the server that has been provisioned.
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture51.png" />
										</div>
										<div className="my-4">
											<img className="img-fluid" src="/src/img/user-guides/Linux_And_Linux+MiddleWare/picture52.png" />
										</div>
									</li>
								</ul>
							</div>
...
export { LinuxAndLinuxPlusMiddleWare as LinuxAndLinuxPlusMiddleWare };