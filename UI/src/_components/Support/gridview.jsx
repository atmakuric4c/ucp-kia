...
class DatatablePage extends React.Component {
    constructor(props) {
        ...
        this.props.tickets.map((ticket, index) =>{
            this.values[index]={
                ...
                action:<a href="javascript:void(0);" onClick={() => this.openModalTicketView(ticket)}><i className="fas fa-reply"></i> </a>
            }
        })
    ...
    render() {
        ...
        return (
            ...
            <h2 style={{color:'red'}}>
            Ticket Details:: {ticket && ticket.ticketmaskid} <a className="float-right" href="javascript:void(0);" onClick={this.closeModal}><i className="fa fa-times" /></a>
            </h2>
