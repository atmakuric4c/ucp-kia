...
class MyTable extends React.Component {
  ...
  openModalIPHistory(ip) {
    this.props.dispatch(ipamActions.getIPUsageHistory(ip.ip_address));
  ...
  IpadmAddRequest = e => {
    ...
    this.props.dispatch(ipamActions.IpadmAddRequest(formData));
    this.setState({ modalIsOpen: false });
    //  } else {
          ...
          >
            ...
            <div className="panel panel-default" >
              ...
              >
                ...
                <div className="form-group">
                  <label htmlFor="gateway">Select VDC Location</label>
                  <select
                    className="form-control"
                    name="vdc_location"
                    required
                    onChange={event => this.validateIPAddress(event)}
                  >
                    <IpamModalComponent data={vdc_locations} />
                  </select>
                </div>
                <div className="form-group">
                  <label htmlFor="network_type">Select Network Type</label>
                  <select
                    className="form-control"
                    required
                    name="network_type"
